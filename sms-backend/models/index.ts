...
// Owner ↔ OwnerReport (1:many)
Owner.hasMany(OwnerReport, { foreignKey: 'owner_id', as: 'owner_reports' })
OwnerReport.belongsTo(Owner, { foreignKey: 'owner_id', as: 'owner' })
// Agent ↔ OwnerReport (1:many)
Agent.hasMany(OwnerReport, { foreignKey: 'agent_id', as: 'owner_reports' })
OwnerReport.belongsTo(Agent, { foreignKey: 'agent_id', as: 'agent' })
